...
//********3) Add next two lines for array and title
         listArray = ["Arctic Monkeys","Bad Religion","Boris","Run The Jewels", "Stone Temple Pilots","The Pretty Reckless", "The Strokes","Wu Tang Clan"]
